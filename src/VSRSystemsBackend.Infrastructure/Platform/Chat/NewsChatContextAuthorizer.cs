...
public sealed class NewsChatContextAuthorizer : IChatContextAuthorizer
{
    public const string TenantId = "news";
    public const string ContextType = "news.message";

    private readonly IRealtimeSubscriptionAuthorizer _bookingAuthorizer;

    public NewsChatContextAuthorizer(IRealtimeSubscriptionAuthorizer bookingAuthorizer)
    {
    ...
    {
        // News messages - authorize based on admin access or valid userId
